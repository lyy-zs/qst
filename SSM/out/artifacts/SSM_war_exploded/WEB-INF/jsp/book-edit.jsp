		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="portlet-body form">
					...
					<form action="${pageContext.request.contextPath}/book/book-edit" method="post" class="horizontal-form">
							...
							<div class="span12 ">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" name="bookName" value="${book.getBookName()}"  class="m-wrap span12">
							...
							<div class="span12 ">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" name="bookCounts" value="${book.getBookCounts()}" class="m-wrap span12">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="span12 ">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text"  name="detail" value="${book.getDetail()}" class="m-wrap span12">
									</div>
