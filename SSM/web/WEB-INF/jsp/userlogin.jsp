...
<div id="container">
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="${pageContext.request.contextPath}/user/userlogin">
            <div>
            ...
            <div>
                <input type="text" name="captcha" placeholder="请输入验证码" autocomplete="off"
                       ...
                       value="xszg">
                <img class="admin-captcha" width="90" height="30" src="${pageContext.request.contextPath}/captcha.jpg">
            </div>
            <button class="layui-btn admin-button" id="button" lay-submit="" lay-filter="login">登 陆</button>
            <a
                    type="button" class="layui-btn admin-button"
                    href="${pageContext.request.contextPath}/user/toRegister">注册
            </a>
        </form>
    </div>
</div>
