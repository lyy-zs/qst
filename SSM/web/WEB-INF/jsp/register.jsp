...
<head>
    ...
    <style>
        body {background-image:url("${pageContext.request.contextPath}/bg.jpg");height:100%;width:100%;}
...
<div id="container">
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="${pageContext.request.contextPath}/user/register">
            <div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    ...
                    <a
                        ...
                        href="${pageContext.request.contextPath}/user/login">取消
                    </a>
                </div>
