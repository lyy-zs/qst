...
<%--							<li><a href="extra_lock.html"><i class="icon-lock"></i> 锁定屏幕</a></li>--%>
							...
							<li><a href="${pageContext.request.contextPath}/upload2"><i class="icon-user"></i> 文件上传</a></li>
							<li><a href="${pageContext.request.contextPath}/user/login"><i class="icon-key"></i> 退出系统</a></li>
